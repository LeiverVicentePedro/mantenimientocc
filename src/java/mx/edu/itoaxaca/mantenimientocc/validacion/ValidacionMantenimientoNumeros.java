...
@FacesValidator("validadoresNumeros")
public class ValidacionMantenimientoNumeros implements Validator {
    private static final String Validador="[0-9]+"+"[ \\t\\n\\x0b\\r\\f]*"+"[0-9]*"+"[ \\t\\n\\x0b\\r\\f]*"+"[0-9]*";
    ...
    public ValidacionMantenimientoNumeros (){
